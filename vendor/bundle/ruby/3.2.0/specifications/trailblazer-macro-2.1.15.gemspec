...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<trailblazer-developer>.freeze, [">= 0.1.0", "< 0.2.0"])
  s.add_runtime_dependency(%q<trailblazer-operation>.freeze, [">= 0.10.1"])
  s.add_runtime_dependency(%q<trailblazer-activity-dsl-linear>.freeze, [">= 1.2.0", "< 1.3.0"])
end
