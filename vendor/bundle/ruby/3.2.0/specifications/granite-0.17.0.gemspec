...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 6.0", "< 7.2"])
  s.add_runtime_dependency(%q<granite-form>.freeze, [">= 0.3.0"])
  ...
  s.add_development_dependency(%q<rubocop-rails>.freeze, ["~> 2.13"])
