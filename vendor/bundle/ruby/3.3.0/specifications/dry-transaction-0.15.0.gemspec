...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<dry-events>.freeze, ["~> 1.0".freeze])
  s.add_runtime_dependency(%q<dry-matcher>.freeze, ["~> 0.10".freeze])
  s.add_runtime_dependency(%q<dry-monads>.freeze, ["~> 1.6".freeze])
end
