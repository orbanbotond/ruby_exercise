...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.93".freeze])
  s.add_development_dependency(%q<rubocop-performance>.freeze, ["~> 1.8".freeze])
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 1.44".freeze])
