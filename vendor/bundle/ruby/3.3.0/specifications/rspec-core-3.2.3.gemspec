...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.2.0".freeze])
  ...
  s.add_development_dependency(%q<aruba>.freeze, ["~> 0.6".freeze])
  s.add_development_dependency(%q<nokogiri>.freeze, ["~> 1.5".freeze])
  s.add_development_dependency(%q<coderay>.freeze, ["~> 1.0.9".freeze])
