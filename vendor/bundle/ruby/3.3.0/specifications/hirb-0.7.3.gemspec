...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<bacon>.freeze, [">= 1.1.0".freeze])
  s.add_development_dependency(%q<mocha>.freeze, ["~> 0.12.1".freeze])
  s.add_development_dependency(%q<mocha-on-bacon>.freeze, ["~> 0.2.1".freeze])
  s.add_development_dependency(%q<bacon-bits>.freeze, [">= 0".freeze])
end
